...
class EntryList(db.Model):
    ...
    entries = db.relationship('Entry', foreign_keys="Entry.entry_list_id", order_by="Entry.id",  back_populates='entry_list', cascade="all, delete-orphan", passive_deletes=True)
